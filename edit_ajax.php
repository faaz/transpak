...
<tr>
				<td><strong>City</strong></td>
				<td width="250"><input type='text' value="<?php echo $row['city'] ?>" name='city' size='43'/></td>

				<!-- mandatory -->
				<td width="76" align="right"><strong>Postcode</strong></td>
				<td width="156"><input type='text' value="<?php echo $row['postcode'] ?>" name='postcode' size='31'/></td>
			</tr>
			<tr>
				<!-- mandatory -->
				<td><strong>Country</strong></td>
				<td><input type='text' value="<?php echo $row['country'] ?>" name='country' size='43'/></td>

				<td align="right">Telephone</td>
				<td><input type='text' value="<?php echo $row['telephone'] ?>" name='telephone' size='31'/></td>
			</tr>
